                                ...
                                <ul>
                                    ...
                                    <li><a href="#">ჩემი ექაუნთი<i class="fi-rs-angle-down"></i></a>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            @else
                                                <ul class="sub-menu">
                                                    <li><a href="{{route('user.dashboard')}}">მომხმარებლის დეშბორდი</a></li>
...
{{--                                                    <a href="{{route('product.details',['slug'=>$products->slug])}}">--}}
                                                    <img alt="" src="">
                                                    </a>
                                            </div>
                    ...
                    <div class="col-lg-7 mb-md-3 mb-lg-0">
                        <div class="row align-items-center">
                            <div class="col flex-horizontal-center">
                                ...
                                <h4 class="font-size-20 mb-0 ml-3">სიახლეების გამოწერა</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        ...
                        <form class="form-subcriber d-flex wow fadeIn animated">
                            ...
                            <button class="btn bg-dark text-white" type="submit">საიტის გამოწერა</button>
                        </form>
                        <!-- End Subscribe Form -->
                    </div>
                </div>
