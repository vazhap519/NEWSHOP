...
@foreach($slides as $slide)
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="href="{{route('product.details',['slug'=>$fproduct->slug])}}">
        ...
        <section class="section-padding">
            <div class="container wow fadeIn animated">
                <h3 class="section-title mb-20"><span>ბოლოს</span> დამატებული პროდუქტები</h3>
                <div class="carausel-6-columns-cover position-relative">
                    <div class="slider-arrow slider-arrow-2 carausel-6-columns-arrow" id="carausel-6-columns-2-arrows"></div>
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        @foreach($lproduct as $l_product)
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{route('product.details',['slug'=>$l_product->slug])}}">
                                        <img class="default-img" src="{{asset('/assets/imgs/products')}}/{{$l_product->image}}" alt="">
                                        <img class="hover-img" src="{{asset('/assets/imgs/products')}}/{{$l_product->image}}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                ...
                                <div class="product-badges product-badges-position product-badges-mrg">
                                    <span class="new">ახალი</span>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                                <h2><a href="product-details.html">{{$l_product->name}}</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
                                <div class="product-price">
                                    @if($l_product->sale_price>0)
                                    <span>{{$l_product->sale_price}}</span>
                                    @endif
                                    <span class="old-price">{{$l_product->regular_price}}</span>
                                </div>
                            </div>
                        </div>
